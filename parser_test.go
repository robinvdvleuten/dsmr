		...
		},
		{
			...
			expected: &AST{
				...
				Data: []*Object{
					...
					obj("0-0:1.0.0", ts("161113205757W")),
					...
					obj("0-1:24.2.1", list(ts("161129200000W"), mm("00981.443", "m3"))),
				},
				Footer: footer("6796"),
			},
		},
		{
			...
			expected: &AST{
				...
				Data: []*Object{
					...
					obj("0-0:1.0.0", ts("170102192002W")),
					obj("0-0:96.1.1", str("4B384547303034303436333935353037")),
					...
					obj("0-1:24.1.0", str("003")),
					obj("0-1:96.1.0", str("3232323241424344313233343536373839")),
					obj("0-1:24.2.1", list(ts("170102161005W"), mm("00000.107", "m3"))),
